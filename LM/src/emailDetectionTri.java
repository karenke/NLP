...
public class emailDetectionTri {
	public static void main(String []args)throws IOException{
		...
		Table beck = new Table("beck-s",beck_tri,beck_bi,beck_un);
		...
		Table farmer = new Table("farmer-d",farmer_tri,farmer_bi,farmer_un);
		...
		Table kaminski = new Table("kaminski-v",kaminski_tri,kaminski_bi,kaminski_un);
		...
		out = "./data/email/emailDetectionTri";
